...
//外部flash存储地址
#define STR_ADDR1			0x000000//0x000000~0x000FFF 4KB		--> bootloader参数
#define STR_ADDR2			0x001000//0x001000~0x001FFF 4KB	  --> 应用参数
#define STR_ADDR3			0x002000//0x002000~0x002FFF 4KB		--> 仅APP中使用的参数
#define STR_ADDR4			0x003000//0x003000~0x003FFF 4KB
#define STR_ADDR5			0x004000//0x004000~0x004FFF 4KB
#define FIRMWARE_ADDR	0x020000//0x020000~0x11FFFF 1MB
...
void w25qFlash_read( void );//读取应用掉电保存的信息
